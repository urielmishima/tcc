...
/*     public IEnumerator FOVKickOut()
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Camera Setup
            ...
            t.mouseInputInversion = (FirstPersonController.InvertMouseInput)EditorGUILayout.EnumPopup(new GUIContent("Mouse Input Inversion","Determines if mouse input should be inverted, and along which axes"),t.mouseInputInversion);
        ...
        #region Audio/SFX Setup
            ...
            EditorGUILayout.Space();
            t.fsmode = (FirstPersonController.FSMode)EditorGUILayout.EnumPopup(new GUIContent("Footstep Mode","Determines the method used to trigger footsetps."),t. fsmode);
            EditorGUILayout.Space();

            #region FS Static
            if(t.fsmode == FirstPersonController.FSMode.Static){
                ...
                t.dynamicFootstep.materialMode = (FirstPersonController.DynamicFootStep.matMode)EditorGUILayout.EnumPopup(new GUIContent("Material Type", "Determines the type of material will trigger footstep audio."),t.dynamicFootstep.materialMode);
                EditorGUILayout.Space();
                #region Wood Section
                ...
                if(showWoodFS){
                    GUILayout.BeginVertical("box");
                    if(t.dynamicFootstep.materialMode == FirstPersonController.DynamicFootStep.matMode.physicMaterial){
